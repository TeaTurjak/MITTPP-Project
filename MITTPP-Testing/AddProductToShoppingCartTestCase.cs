...
{
    [TestFixture]
    public class AddProductToShoppingCartTestCase
    {
        ...
        [Test]
        public void TheAddProductToShoppingCartTestCaseTest()
        {
            ...
            new SelectElement(driver.FindElement(By.Id("pa_size"))).SelectByText("XS");
